...
// import ScholarIcon from "./icons/ScholarIcon"; // Commented out as it's not used
// import SourceControlIcon from "./icons/SourceControlIcon"; // Commented out as it's not used
  ...
  return (
    <footer className={styles.bottomBar}>
      <div className={styles.container}>
        {/* <a
          href="https://github.com/deepblue597/vscode-portfolio"
          target="_blank"
      ...
      <div className={styles.container}>
        ...
        <a href="https://github.com/deepblue597" target="_blank" rel="noopener">
          <div className={styles.section}>
